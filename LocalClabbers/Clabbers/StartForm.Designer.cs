namespace Clabbers
{
	partial class StartForm
	{
		...
		private void InitializeComponent()
		{
         ...
         this.mapTextBox.DoubleClick += new System.EventHandler(this.mapTextBox_Click);
         // 
         // label2
         // 
         ...
         this.tilesTextBox.DoubleClick += new System.EventHandler(this.tilesTextBox_Click);
         // 
         // handSizeTextBox
         // 
         ...
         this.wordsTextBox.DoubleClick += new System.EventHandler(this.wordsTextBox_Click);
         // 
         // label4
         // 
