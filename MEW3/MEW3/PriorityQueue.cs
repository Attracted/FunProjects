...
namespace MEW3
{
   ...
   public class SquareGrid : WeightedGraph<Location>
   {
      ...
      public Location GetOtherPortalOrDefault(Location a)
      {         
         var tuple = Portals.FirstOrDefault(t => t.Item2 == a);
         if (tuple == null)
         {
            return a;
         }

         var portal = Portals.FirstOrDefault(t => t.Item1 == tuple.Item1 && t.Item2 != a);
         if (portal == null)
         {
            return a;
         }
      ...
      public IEnumerable<Location> Neighbors(Location id)
      {
         foreach (var dir in DIRS)
         {
            ...
            Location next = new Location(xDir, yDir);
            ...
            //else if (yDir == 7)
            //{
            //   //Consider passing in map 'portals' to help find Neighbors
            //   if (xDir == -1)
            //   {
            //      yield return new Location(17, yDir);
            //   }
            //   else if (xDir == 17)
            //   {
            //      yield return new Location(-1, yDir);
            //   }
            //}
         }
      }
